...
<body>
    ...
    {
        $count=0;
        $res = mysqli_query($link,"select * from admin_login where username='$_POST[username]'") or die(mysqli_error($link));
        ...
        if($count>0)
        {
            ...
            mysqli_query($link,"insert into admin_login values('$_POST[userId]','$_POST[username]','$_POST[password]')") or die(mysqli_error($link));
            ?>
            <script type="text/javascript">
