    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                <div class="login-logo" style="color:white; font-size: 24px;">
                    Admin Login
                </div>
                ...
                <div class="login-form" >
                    ...
                    <a href="adminregister.php">   <button type="submit" name="submit1" class="btn btn-info btn-flat m-b-30 m-t-30" >Registration</button> </a>
