                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="form-group"><label for="vat" class=" form-control-label">Exam Time In Minutes </label><input type="number" name="examtime" placeholder="Exam Time In Minutes" class="form-control"  ></div>
